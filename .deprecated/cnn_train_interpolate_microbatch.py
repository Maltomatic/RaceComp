...
from models.cnn_resize_conv_upscaler import Resnet_Interpolate_Upscaler
...
desc = "cnn_interpolate_percep_microbatch"
...
if __name__ == "__main__":
    ...
    if TRAINING:
        ...
        ckpt_path = "checkpoints_inter/best_stage2_epoch3.pt"
        ...
        output_pil.save(f"test_files/outputs/unet_interpolate_output_{testpath}.png")
